...
public class TalonMPLogger {
	...
	public TalonMPLogger(ArrayList<Double> position, ArrayList<Double> velocity, double clk, double finalValue, double dist) {
		m_position = position;
		m_velocity = velocity;
		m_clk = clk;
	...
	public void logData(){
		FileWriter writer;
		try {
			writer = new FileWriter("GeneratedTalonMP.java");
			writer.append("/**" + '\n' + " * Generated by the TalonMPLogger in TalonTrapezoidal mode" + '\n' + " */" + '\n' + '\n');
			
			writer.append("public class GeneratedTalonMP {" + '\n' + '\n' + '\t');
			writer.append("public static final int kNumPoints = " + m_finalValue + ";" + '\n' + '\n' + '\t');
